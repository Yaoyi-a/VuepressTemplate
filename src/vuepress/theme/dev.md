...
- [Markdown 插槽](https://v1.vuepress.vuejs.org/zh/guide/markdown-slot.html)
...
随着需求的变化，只有一个布局组件 `Layout.vue` 可能还不够，你可能想要定义更多的布局组件用于不同的页面，你可能还想要自定义一个[调色板](https://v1.vuepress.vuejs.org/zh/config/#palette-styl)，甚至应用一些插件。
...
如果你开发/编写了一个本地主题，不需要填写`theme`属性，因为`.vuepress/theme`文件夹的内容会自动应用为**local theme**。
:::
...
- [全局计算属性](https://v1.vuepress.vuejs.org/zh/guide/global-computed.html).
